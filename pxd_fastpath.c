...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(4,13,0) || (LINUX_VERSION_CODE >= KERNEL_VERSION(4,12,0) && defined(bvec_iter_sectors))
		if (bio->bi_status) {
...
#elif LINUX_VERSION_CODE >= KERNEL_VERSION(4,14,0) || (LINUX_VERSION_CODE >= KERNEL_VERSION(4,12,0) && defined(bvec_iter_sectors))
