 ...
 * Original file: dm-cache-background-tracker.c
 */
...
struct background_tracker *btracker_create(unsigned max_work) {
        ...
        if (!b) {
                printk("couldn't create background_tracker");
                return NULL;
        }
        ...
        if (!b->work_cache) {
                printk("couldn't create mempool for background work items");
                kfree(b);
                b = NULL;
        }
...
static int cmp_oblock(oblock_t lhs, oblock_t rhs) {
...
static bool __insert_pending(struct background_tracker *b, struct bt_work *nw) {
        int cmp;
        struct bt_work *w;
...
int btracker_queue(struct background_tracker *b, struct policy_work *work,
