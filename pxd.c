...
// ELRepo 7.2 / mainline dropped the transitive <linux/string.h> chain
// through <linux/module.h> et al., so strncpy() is no longer visible
// unless we include it explicitly.
